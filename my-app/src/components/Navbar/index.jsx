...
function Navbar() {
  return (
    <div>
      <nav class="flex items-center justify-between flex-wrap bg-[#d0cba0] py-2 lg:px-12 border-solid border-t-2 border-blue-700">
        ...
        <div class="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
          <div class="text-md font-bold text-[#282517] lg:flex-grow">
            <a
              ...
              class="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded"
            >
              Wanita
            </a>
            <a
          ...
          <div class="relative mx-auto text-gray-600 lg:block hidden">
            <input
              class="border-2 border-gray-300 bg-white h-10 pl-2 pr-8 rounded-lg text-sm"
              type="search"
              name="search"
              placeholder="Search"
            />
